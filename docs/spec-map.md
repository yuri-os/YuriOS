...
| **§2** — The brain, the voice, and the seam | `web/js/chat.js`<br>`yurios/world/main.py`<br>`yurios/app/providers/sentence_tf.py`<br>`yurios/world/boot.py`<br>*+31 more* | `tests/test_events.py`<br>`tests/test_situation.py`<br>`tests/test_voice_ws_fork.py`<br>*+11 more* |
