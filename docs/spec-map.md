...
| **§7** — Tools via MCP: the hands | `yurios/world/tools/client.py`<br>`yurios/world/brain.py`<br>`yurios/world/selfies.py`<br>`yurios/world/tools/guard.py`<br>*+40 more* | `tests/test_mcp_contract.py`<br>`tests/test_selfie.py`<br>`tests/test_tool_loop.py`<br>*+16 more* |
...
| **§9** — The voice loop | `web/js/voice.js`<br>`yurios/world/routes/voice_ws.py`<br>`yurios/world/main.py`<br>`web/js/chat.js`<br>*+7 more* | `tests/test_text_style.py`<br>`tests/test_voice_handshake.py`<br>`tests/test_voice_replay.py`<br>*+1 more* |
| **§10** — Topology: one event bus + one audio socket | `yurios/world/main.py`<br>`yurios/world/channels/telegram.py`<br>`yurios/envfile.py`<br>`yurios/kernel/hub.py`<br>*+22 more* | `tests/test_channels.py`<br>`tests/test_host.py`<br>`tests/test_pictures.py` |
...
*730 citation sites over 108 sections.*
