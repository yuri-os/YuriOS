...
| **§2** — The brain, the voice, and the seam | `web/js/chat.js`<br>`yurios/world/main.py`<br>`yurios/app/providers/sentence_tf.py`<br>`yurios/world/boot.py`<br>*+32 more* | `tests/test_embedder_fallback.py`<br>`tests/test_events.py`<br>`tests/test_situation.py`<br>*+12 more* |
...
*833 citation sites over 114 sections.*
