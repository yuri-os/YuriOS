...
| **§7** — Tools via MCP: the hands | `yurios/world/selfies.py`<br>`yurios/world/main.py`<br>`yurios/world/brain.py`<br>`yurios/world/tools/client.py`<br>*+41 more* | `tests/test_mcp_contract.py`<br>`tests/test_selfie.py`<br>`tests/test_tool_loop.py`<br>*+18 more* |
...
*813 citation sites over 113 sections.*
