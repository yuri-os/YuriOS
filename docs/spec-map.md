...
| **§2** — The brain, the voice, and the seam | `web/js/chat.js`<br>`yurios/app/providers/sentence_tf.py`<br>`yurios/world/main.py`<br>`yurios/world/boot.py`<br>*+32 more* | `tests/test_events.py`<br>`tests/test_situation.py`<br>`tests/test_voice_ws_fork.py`<br>*+12 more* |
...
*766 citation sites over 109 sections.*
