...
| **§16** — The signal bus (inbound) | `yurios/mind/signals.py`<br>`yurios/mind/loop.py`<br>`yurios/world/main.py`<br>`yurios/mind/dreamjobs/builtins.py`<br>*+3 more* | `tests/test_mind_goals.py`<br>`tests/test_signal_bus.py` |
...
*847 citation sites over 115 sections.*
