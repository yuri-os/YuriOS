...
| **§7** — Tools via MCP: the hands | `yurios/world/tools/client.py`<br>`yurios/world/brain.py`<br>`yurios/world/selfies.py`<br>`yurios/world/config.py`<br>*+40 more* | `tests/test_mcp_contract.py`<br>`tests/test_selfie.py`<br>`tests/test_tool_loop.py`<br>*+16 more* |
...
| **§10** — Topology: one event bus + one audio socket | `yurios/world/main.py`<br>`yurios/envfile.py`<br>`yurios/world/channels/telegram.py`<br>`yurios/world/routes/voice_ws.py`<br>*+19 more* | `tests/test_channels.py`<br>`tests/test_host.py`<br>`tests/test_pictures.py` |
...
| **§21** — DREAM consolidation | `yurios/mind/dreamjobs/filedsl.py`<br>`yurios/ctl/dreams.py`<br>`yurios/mind/dream.py`<br>`yurios/mind/dreamjobs/__init__.py`<br>*+5 more* | `tests/test_dreamjobs.py`<br>`tests/test_mind_routes.py`<br>`tests/test_cli_dreams.py`<br>*+1 more* |
...
*694 citation sites over 106 sections.*
