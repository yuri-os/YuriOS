...
|---|---|---|
| `yurios/app/conversation.py` | **`tests/test_conversation.py`**<br>`tests/test_channels.py`<br>`tests/test_inbox.py`<br>`tests/test_mind_loop.py`<br>`tests/test_voice_ws_fork.py`<br>`tests/test_voice_replay.py` | 29 |
| `yurios/app/core/assemble.py` | `tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_soul.py`<br>`tests/test_knowledge_slot.py`<br>`tests/test_mind_loop.py`<br>`tests/test_promptlog.py` | 14 |
| `yurios/app/core/soul.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_soul.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_promptlog.py` | 18 |
| `yurios/app/corpus.py` | `tests/test_mind_loop.py`<br>`tests/test_integration.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_promptlog.py`<br>`tests/test_bootstrap_greeting.py` | 13 |
| `yurios/app/main.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_studio_routes.py`<br>`tests/test_promptlog.py` | 21 |
| `yurios/app/memory/index.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_dreamjobs.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_self_goals.py` | 20 |
| `yurios/app/memory/partner.py` | **`tests/test_partner.py`**<br>`tests/test_mind_scenarios.py` | 19 |
| `yurios/app/memory/reindex.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_bootstrap_greeting.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_promptlog.py` | 13 |
| `yurios/app/memory/store.py` | `tests/test_dreamjobs.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_integration.py` | 19 |
| `yurios/app/providers/admission.py` | `tests/test_openrouter_attribution.py`<br>`tests/test_mind_loop.py`<br>`tests/test_channels.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_inbox.py` | 30 |
...
| `yurios/app/providers/openrouter.py` | `tests/test_openrouter_attribution.py`<br>`tests/test_inference_admission.py`<br>`tests/test_card_optimize.py` | 7 |
...
| `yurios/app/sessions.py` | `tests/test_conversation.py`<br>`tests/test_mind_loop.py`<br>`tests/test_integration.py`<br>`tests/test_mind_goals.py`<br>`tests/test_text_style.py`<br>`tests/test_mind_hands.py` | 14 |
| `yurios/app/vaultgit.py` | `tests/test_host_debug.py`<br>`tests/test_vault_commit_noise.py`<br>`tests/test_dreamjobs.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_routes.py` | 38 |
...
| `yurios/characters/models.py` | `tests/test_host.py`<br>`tests/test_characters_exporter.py`<br>`tests/test_export_privacy.py`<br>`tests/test_migration.py`<br>`tests/test_character_overrides.py`<br>`tests/test_characters_registry.py` | 18 |
...
| `yurios/characters/registry.py` | `tests/test_host.py`<br>`tests/test_characters_exporter.py`<br>`tests/test_export_privacy.py`<br>`tests/test_migration.py`<br>`tests/test_character_overrides.py`<br>`tests/test_characters_registry.py` | 19 |
| `yurios/characters/selfiebook.py` | `tests/test_selfie_book_per_character.py`<br>`tests/test_studio_routes.py` | 2 |
| `yurios/characters/setting.py` | `tests/test_characters_exporter.py`<br>**`tests/test_setting.py`**<br>`tests/test_host.py`<br>`tests/test_export_privacy.py`<br>`tests/test_card_roundtrip.py`<br>`tests/test_studio_routes.py` | 23 |
| `yurios/characters/soulfiles.py` | `tests/test_characters_exporter.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_export_privacy.py`<br>`tests/test_studio_routes.py` | 25 |
...
| `yurios/desktop/brain.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_promptlog.py`<br>`tests/test_mind_hands.py`<br>`tests/test_bootstrap_greeting.py`<br>`tests/test_mind_scenarios.py` | 17 |
...
| `yurios/desktop/voice/sentences.py` | `tests/test_voice_ws_fork.py`<br>`tests/test_voice_replay.py`<br>`tests/test_voice_stack.py`<br>`tests/test_integration.py`<br>`tests/test_voice_handshake.py`<br>`tests/test_pictures.py` | 8 |
...
| `yurios/desktop/voice/transcript.py` | `tests/test_channels.py`<br>`tests/test_voice_ws_fork.py`<br>`tests/test_boot.py`<br>`tests/test_voice_replay.py`<br>`tests/test_text_style.py`<br>`tests/test_voice_limits.py` | 7 |
| `yurios/desktop/voice/turn.py` | `tests/test_voice_replay.py`<br>`tests/test_voice_ws_fork.py`<br>`tests/test_voice_stack.py`<br>`tests/test_voice_handshake.py`<br>`tests/test_integration.py`<br>`tests/test_voice_limits.py` | 8 |
...
| `yurios/kernel/clock.py` | `tests/test_dreamjobs.py`<br>`tests/test_channels.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_hands.py`<br>`tests/test_pictures.py`<br>`tests/test_mind_goals.py` | 44 |
| `yurios/kernel/correlate.py` | `tests/test_mind_goals.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_promptlog.py`<br>`tests/test_mind_routes.py` | 16 |
| `yurios/kernel/hub.py` | `tests/test_channels.py`<br>`tests/test_events.py`<br>`tests/test_inbox.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py` | 34 |
...
| `yurios/mind/dream.py` | `tests/test_dreamjobs.py`<br>**`tests/test_dream.py`**<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_mind_hands.py` | 12 |
| `yurios/mind/dreamjobs/builtins.py` | `tests/test_dreamjobs.py`<br>`tests/test_self_goals.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_routes.py`<br>`tests/test_mind_goals.py` | 11 |
...
| `yurios/mind/dreamjobs/runner.py` | `tests/test_dreamjobs.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_self_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_routes.py` | 11 |
| `yurios/mind/goals.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_self_goals.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_mind_routes.py` | 11 |
| `yurios/mind/goalwork.py` | `tests/test_mind_hands.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_soul.py`<br>`tests/test_mind_loop.py` | 5 |
| `yurios/mind/hands.py` | `tests/test_mind_hands.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_dreamjobs.py`<br>`tests/test_mind_scenarios.py` | 15 |
| `yurios/mind/housekeeping.py` | `tests/test_mind_goals.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_mind_soul.py`<br>`tests/test_mind_routes.py` | 10 |
...
| `yurios/mind/promptlog.py` | `tests/test_mind_hands.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>**`tests/test_promptlog.py`**<br>`tests/test_mind_scenarios.py`<br>`tests/test_mind_soul.py` | 10 |
...
| `yurios/mind/selfedit.py` | **`tests/test_selfedit.py`**<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_routes.py`<br>`tests/test_mind_scenarios.py` | 11 |
| `yurios/mind/signals.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_channels.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_events.py` | 28 |
...
| `yurios/mind/util.py` | `tests/test_host_debug.py`<br>`tests/test_mind_util.py`<br>`tests/test_knowledge.py`<br>`tests/test_mind_loop.py`<br>`tests/test_gallery.py`<br>`tests/test_mind_goals.py` | 34 |
| `yurios/mind/vaultio.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_mind_routes.py`<br>`tests/test_dreamjobs.py` | 19 |
| `yurios/mind/workspace.py` | `tests/test_dreamjobs.py`<br>**`tests/test_workspace.py`**<br>`tests/test_mind_hands.py`<br>`tests/test_self_goals.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_loop.py` | 14 |
| `yurios/mind/world.py` | `tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_mind_hands.py`<br>`tests/test_world_model.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_promptlog.py` | 11 |
...
| `yurios/security.py` | `tests/test_host.py`<br>`tests/test_host_debug.py`<br>`tests/test_mind_routes.py`<br>`tests/test_channels.py`<br>`tests/test_studio_routes.py`<br>`tests/test_pairing.py` | 38 |
| `yurios/world/avatar/controller.py` | `tests/test_channels.py`<br>`tests/test_mind_hands.py`<br>`tests/test_avatar_controller.py`<br>`tests/test_mind_goals.py`<br>`tests/test_pictures.py`<br>`tests/test_situation.py` | 34 |
| `yurios/world/boot.py` | `tests/test_voice_stack.py`<br>**`tests/test_boot.py`**<br>`tests/test_voice_ws_fork.py`<br>`tests/test_channels.py`<br>`tests/test_voice_replay.py`<br>`tests/test_studio_routes.py` | 20 |
| `yurios/world/brain.py` | `tests/test_tool_loop.py`<br>`tests/test_mind_loop.py`<br>`tests/test_mind_hands.py`<br>`tests/test_selfie.py`<br>`tests/test_mind_goals.py`<br>`tests/test_text_style.py` | 17 |
| `yurios/world/channels/manager.py` | `tests/test_channels.py`<br>`tests/test_inbox.py`<br>`tests/test_pictures.py`<br>`tests/test_voice_stack.py`<br>`tests/test_studio_routes.py`<br>`tests/test_context_meter.py` | 19 |
| `yurios/world/channels/notify.py` | `tests/test_inbox.py` | 1 |
| `yurios/world/channels/telegram.py` | `tests/test_channels.py` | 2 |
| `yurios/world/context.py` | `tests/test_context_meter.py`<br>`tests/test_channels.py`<br>`tests/test_inbox.py`<br>`tests/test_pictures.py`<br>`tests/test_studio_routes.py`<br>`tests/test_voice_stack.py` | 18 |
...
| `yurios/world/inbox.py` | **`tests/test_inbox.py`**<br>`tests/test_host.py` | 20 |
| `yurios/world/main.py` | `tests/test_channels.py`<br>`tests/test_inbox.py`<br>`tests/test_pictures.py`<br>`tests/test_voice_stack.py`<br>`tests/test_studio_routes.py`<br>`tests/test_conversation.py` | 22 |
...
| `yurios/world/routes/chat.py` | `tests/test_channels.py`<br>`tests/test_pictures.py`<br>`tests/test_boot.py` | 5 |
...
| `yurios/world/selfies.py` | `tests/test_selfie.py`<br>`tests/test_channels.py`<br>`tests/test_inbox.py`<br>`tests/test_pictures.py`<br>`tests/test_voice_stack.py`<br>`tests/test_context_meter.py` | 25 |
| `yurios/world/situation.py` | `tests/test_mind_hands.py`<br>`tests/test_mind_goals.py`<br>**`tests/test_situation.py`**<br>`tests/test_world_model.py`<br>`tests/test_mind_loop.py`<br>`tests/test_setting.py` | 14 |
| `yurios/world/tools/client.py` | `tests/test_tool_loop.py`<br>`tests/test_studio_routes.py`<br>`tests/test_multi_server.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mcp_contract.py`<br>`tests/test_selfie.py` | 8 |
...
| `yurios/world/tools/guard.py` | `tests/test_tool_loop.py`<br>`tests/test_mind_hands.py`<br>**`tests/test_guard.py`**<br>`tests/test_mind_loop.py`<br>`tests/test_mind_goals.py`<br>`tests/test_selfie.py` | 30 |
...
| `yurios/world/tools/timers.py` | `tests/test_channels.py`<br>`tests/test_pictures.py`<br>`tests/test_voice_stack.py`<br>`tests/test_studio_routes.py`<br>`tests/test_mind_scenarios.py`<br>`tests/test_daemon.py` | 28 |
...
| `yurios/world/turns.py` | `tests/test_channels.py`<br>`tests/test_pictures.py`<br>`tests/test_draft_cadence.py`<br>`tests/test_voice_stack.py` | 18 |
...
| `yurios/world/vram.py` | **`tests/test_vram.py`**<br>`tests/test_channels.py`<br>`tests/test_mind_loop.py`<br>`tests/test_inbox.py`<br>`tests/test_mind_hands.py`<br>`tests/test_mind_goals.py` | 30 |
| `yurios/world/window.py` | **`tests/test_window.py`** | 1 |

## Declarations only (15)
